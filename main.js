...
function Read() {
  ...
  if (getUserList != null) {
    if (getUserList.length === 0) {
      nameListDOM.innerHTML = "Yapılması Gereken Herhangi Bir İş Yok...";
    } else {
...
function Create() {
  ...
  if (inputText == "") {
    alert("Yapılacak Kısmını Boş Bırakmayınız...");
  } else {
    if (storage === null) {
...
function Update(item) {
  ...
  if (updateUsers[item] == "") {
    alert("Yapılacak İşi Güncelleyiniz...");
  } else {
